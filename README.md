...
| 📝 **护肤好文** | AI 每日生成护肤科普文章，涵盖成分解析、季节护理、误区解答 |
| 💡 **护肤小贴士** | 内置 50 条精选护肤知识（清洁/保湿/防晒/抗老/美白/敏感/痘痘/饮食/睡眠） |
| ⚙️ **自定义 AI** | 支持配置自己的 AI 服务商和模型 |
...
| **AI 能力** | Supabase Edge Functions 调用 AI 模型进行肤质分析、产品推荐、内容生成 |
